...
REVOKE ALL ON FUNCTION public.persist_unified_turn(uuid, uuid, jsonb, jsonb, text, integer, integer, integer, integer) FROM anon;
REVOKE ALL ON FUNCTION public.persist_unified_turn(uuid, uuid, jsonb, jsonb, text, integer, integer, integer, integer) FROM authenticated;
